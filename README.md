...
python run_tests.py                  # all suites (unit + integration)
python run_tests.py --unit           # unit suites, no Ollama, ~1s
python run_tests.py --integration    # integration suites, needs Ollama
